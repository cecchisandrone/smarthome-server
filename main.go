...
func main() {
	...
	controllers := []controller.Controller{&controller.HealthCheck{}, &controller.Profile{}, &controller.Configuration{}, &controller.Camera{}, &controller.Authentication{}, &controller.Temperature{}, &controller.Raspsonar{}, &controller.Gate{}, &controller.Notification{}, &controller.Alarm{}, &controller.WellPump{}, &controller.RainGauge{}, &controller.Humidity{}, &controller.Inverter{}, &controller.Heater{}, &controller.PowerMeter{}, &controller.Relay{}}
	services := []service.Service{&service.Profile{}, &service.Configuration{}, &service.Camera{}, &service.Temperature{}, &service.Raspsonar{}, &service.Gate{}, &service.Notification{}, &service.Alarm{}, &service.WellPump{}, &service.RainGauge{}, &service.Humidity{}, &service.Inverter{}, &service.Heater{}, &service.PowerMeter{}, &service.Relay{}}
