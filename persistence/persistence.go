...
func Init() *gorm.DB {
	...
	//Migrate the schema
	db.AutoMigrate(&model.Profile{}, &model.Configuration{}, &model.Camera{}, &model.Gate{}, &model.Raspsonar{}, &model.Temperature{}, &model.Slack{}, &model.Alarm{}, &model.WellPump{}, &model.RainGauge{}, &model.Humidity{}, &model.Inverter{})
